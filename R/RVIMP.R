...
#
# -------------------------------------------------------------------------------
#' Estimation of permutation variable importance measures corrected for dependencies in Random Forests
#' @description RVIMP is a way to improve the interpretation of variables in Random Forests. The procedure is based on the permutation variable importance measure, first mentioned by Breiman 2001. HIER SOLLTEN WIR UNS DANN VERMUTLICH ZUSAMMEN ETWAS AUSDENKEN.
...
#' @param keep.ranger Shall generated ranger object be kept.
...
#' @references
#' \itemize{
#'   \item Breimann L. Random Forests, Mach. Learn. 2001; 45(1):5-32.
#'   \item Gregorutti B, Saint-Pierre P. Correlation and variable importance in random forests, Stat Comput 2017; 27:659-678
