...
#' \item{x6}{Independend from all other covariates. Correlation with y of about -0.36.}
#' \item{x7}{Independend from all other covariates. Correlation with y of about -0.15.}
#' \item{x8}{Independend from all other covariates and y.}
#' \item{x9}{Independend from all other covariates and y.}
#' \item{x10}{Independend from all other covariates and y.}
#' \item{x11}{Independend from all other covariates and y.}
